        ...
        child: FadeTransition(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Ghar Ka Mali', style: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Text('Your Garden, Our Care', style: TextStyle(color: Colors.white.withOpacity(0.8), fontSize: 16)),
