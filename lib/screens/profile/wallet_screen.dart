...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final res =
          await context.read<ApiService>().getMyPayments();
      // FIX: Backend returns res['data'] as flat array, not res['data']['payments']
      final data = res['data'];
      setState(() {
        if (data is List) {
          _transactions = data;
        } else if (data is Map && data['payments'] != null) {
          _transactions = data['payments'];
        } else {
          _transactions = [];
        }
      });
    ...
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
            builder: (_) => PaymentScreen(
                ...
                amount: amount,
                label:
                    'Wallet Top-up ₹${amount.toStringAsFixed(0)}')));
    if (result != null) {
      _amountCtrl.clear();
          ...
          children: [
            Container(
              ...
              child: Column(children: [
                ...
                const Text('Available to use on bookings',
                    style: TextStyle(
            ...
            GkmCard(
                child: Column(
                  ...
                  const SizedBox(height: 4),
                  const Text('Top up your wallet using PayU',
                      style: TextStyle(
    ...
    return Container(
      ...
      child: GkmCard(
        ...
        Container(
          ...
          child: Icon(_icons[type] ?? Icons.payment,
              color: color, size: 20),
        ),
