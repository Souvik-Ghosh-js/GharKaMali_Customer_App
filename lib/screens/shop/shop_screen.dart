...
class _ShopScreenState extends State<ShopScreen> {
  List _products = [];
  List _categories = [];
  Map? _selectedCategory; // FIX: store full category map (need name not id)
  bool _loading = true;
  ...
  Future<void> _load() async {
    ...
    try {
      final [c, p] = await Future.wait([
        ...
        // FIX: pass category name/slug not id
        api.getShopProducts(
  ...
  Widget _filterChip(Map? cat, String label) {
                ...
                child: Column(
                  ...
                  Row(children: [
                    ...
                    if (product['stock_quantity'] != null &&
                        (product['stock_quantity'] as int) < 10)
                      Text(
